...
public class TextFileOpener extends JFrame
{
    ...
    public TextFileOpener()
    {
        ...
        setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);    //设置窗体默认关闭方式
        ...
        //为打开菜单项添加监听器
        mi_open.addActionListener(arg0 -> {
        ...
        //为退出菜单项添加监听器
        mi_exit.addActionListener(arg0 -> {
            System.exit(0);    //退出系统
        });
        ...
        //添加动作监听器
        btn_open.addActionListener(arg0 -> {
            openTextFile();    //调用方法，操作文件
        });
        ...
        //添加动作监听器
        btn_exit.addActionListener(arg0 -> {
            System.exit(0);    //退出系统
        });
